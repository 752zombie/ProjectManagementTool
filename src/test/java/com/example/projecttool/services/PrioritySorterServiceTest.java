...
class PrioritySorterServiceTest {
    ...
    void prioritySorter() {
        ...
        Task task = new Task(1, "Test", "Test1", "2014-05-05", "2014-06-06", "low", 1, 1, "YES");
        Task task1 = new Task(1, "Test", "Test1", "2014-05-05", "2014-06-06","medium", 1, 1, "NO");
        Task task2 = new Task(1, "Test", "Test1", "2014-05-05", "2014-06-06","high", 1, 1, "YES");
        Task task3 = new Task(1, "Test", "Test1", "2014-05-05", "2014-06-06","high", 1, 1, "YES");
        Task task4 = new Task(1, "Test", "Test1", "2014-05-05", "2014-06-06", "high", 1, 1, "NO");
        taskList.add(task);
        taskList.add(task1);
        taskList.add(task2);
        taskList.add(task3);
